...
const simple_linalg_2 = require("simple-linalg");
const simple_linalg_3 = require("simple-linalg");
...
(0, ava_1.default)('Observation covariance test', t => {
    ...
    t.true((0, simple_linalg_3.sum)(kalmanGain1) > (0, simple_linalg_3.sum)(kalmanGain2));
...
(0, ava_1.default)('Fitted observation', t => {
    ...
    const dist1 = (0, simple_linalg_2.frobenius)(defaultOptions.dynamic.init.mean, corrected1.mean);
    const dist2 = (0, simple_linalg_2.frobenius)(defaultOptions.dynamic.init.mean, corrected2.mean);
