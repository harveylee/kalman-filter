...
test('Check constant acceleration', () => {
	const previousCorrected = new State({
		mean: [[0], [1], [1]],
		covariance: [
			[1, 0, 0],
...
test('Registering custom speed', () => {
	...
	registerDynamic('custom-speed', (dynamic, observation) => {
...
test('Init and registered model', () => {
	const kf = new KalmanFilter({
		observation: {
			dimension: 1,
			covariance: [[1]],
