...
test('Polymorphism', () => {
	...
	expect(isState(predicted1)).toBeTruthy();
	expect(isState(predicted2)).toBeTruthy();
	expect(isState(predicted3)).toBeTruthy();
	expect(isState(corrected1)).toBeTruthy();
	expect(isState(corrected2)).toBeTruthy();
	expect(isState(corrected3)).toBeTruthy();
...
test('Polymorphism on observation', () => {
...
test('Dynamic init', () => {
	...
	expect(isState(predicted)).toBeTruthy();
	expect(isState(corrected)).toBeTruthy();
...
test('stateProjection dimensions', () => {
...
test('Dimension Error with stateProjection', () => {
	const badSetOptions = {
		...defaultOptions,
		dynamic: {
			...defaultOptions.dynamic,
...
test('Dimension Error with Transition', () => {
	const badSetOptions = {
		...defaultOptions,
		dynamic: {
			...defaultOptions.dynamic,
...
test('Observed and State Projections', () => {
	const badSetOptions = {
		...defaultOptions,
		observation: {
			...defaultOptions.observation,
